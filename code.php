        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<div class="col-auto float-right ml-auto">
								<a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_expense"><i class="fa fa-plus"></i> Add</a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
					...
					<!-- Search Filter -->
					<form action="get_code.php" method="posts">
						...
						<div class="col-sm-6 col-md-3 col-lg-3 col-xl-2 col-12">  
							<div class="form-group form-focus select-focus">
								<select class="select floating" name="type"> 
									...
									<option value="An Khang">An Khang</option>
									<option value="Thịnh Vượng">Thịnh Vượng</option>
									<option value="Tài Lộc">Tài Lộc</option>
									<option value="Hạnh Phúc">Hạnh Phúc</option>
									<option value="Như Ý">Như Ý</option>
									<option value="Đại Phú">Đại Phú</option>
									<option value="Đại Quý">Đại Quý</option>
									<option value="May Mắn">May Mắn</option>
									<option value="Sức Khỏe">Sức Khỏe</option>
									<option value="Sum Vầy">Sum Vầy</option>
								</select>
								<label class="focus-label">Type By</label>
							</div>
						</div>
						<div class="col-sm-6 col-md-3 col-lg-3 col-xl-2 col-12"> 
							<div class="form-group form-focus select-focus">
								...
								<label class="focus-label">Status By</label>
							</div>
						</div>
						<div class="col-sm-6 col-md-3 col-lg-3 col-xl-2 col-12">  
						...
						<div class="col-md-12">
							<div class="table-responsive">
								<table class="table table-striped custom-table mb-0 datatable">
									...
									<?php
										$conn = new mysqli(servername,username,password,dbname);
										$sql = "SELECT * FROM code WHERE tinhtrang=0";
										$sstype = '';

										if (isset($_SESSION['filter']['type'])){
											$sstype = $_SESSION['filter']['type'];
											unset($_SESSION['filter']['type']);

											$sql = "SELECT * FROM code WHERE loaicode='$sstype' AND tinhtrang=0";
										}
										else {
											$sql = "SELECT * FROM code WHERE tinhtrang=0";
										}
													...
													<td class="text-center">
														<div class="dropdown action-label">
															<a class="btn btn-white btn-sm btn-rounded dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false">
																<i class="fa fa-dot-circle-o text-'.$buget.'"></i> '.$tinhtrang.'
															</a>
															<div class="dropdown-menu dropdown-menu-right">
																<a class="dropdown-item" href="change_status.php?action=1&id='.$row['id'].'"><i class="fa fa-dot-circle-o text-danger"></i> Sold</a>
																<a class="dropdown-item" href="change_status.php?action=0&id='.$row['id'].'"><i class="fa fa-dot-circle-o text-success"></i> Unused</a>
															</div>
														</div>
													</td>
													<td class="text-right">
				...
				<div id="add_expense" class="modal custom-modal fade" role="dialog">
					<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
						<div class="modal-content">
							<form action="code_progress.php" method="post">
